...
class GenreController extends AbstractController
{
    ...
    public function create(Request $request, EntityManagerInterface $em, GenreRepository $genreRepository): Response
    {
        $genre = new Genre();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $findGenre = $genreRepository->findOneBy(['intitule' => $form->get('intitule')->getData()]);
            if ($findGenre) {
                $this->addFlash('danger', 'Le genre ' . $findGenre->getIntitule() . ' Existe deja !');
